...
public class MedKit {
    ...
    public MedKit(String configID, String name, int antiseptic, int ointment, ItemStack input, ItemStack output, double health) {
        uid = uuid++;
    ...
    public void save() {
        ...
        config.set("heal.medkit.kit." + configID + ".health", health);
