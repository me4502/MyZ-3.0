...
public class PlayerData {
    ...
    private String clan, location;
    private List<UUID> friends = new ArrayList<UUID>();

    private PlayerData(UUID uid, String location, int player_kills, int zombie_kills, int pigman_kills, int giant_kills, int player_kills_life,
    ...
    public static PlayerData getDataFor(UUID player) {
        ...
        return new PlayerData(player, section.getString("location"), section.getInt("player_kills"), section.getInt("zombie.kills"), section.getInt("pigman.kills"),
